...
VKDescriptorSetLayout::VKDescriptorSetLayout(VKContext& context, const VKDescriptorSetLayoutInfo& descriptorSetLayoutInfo): VKObject(context), _bindingsInfo(descriptorSetLayoutInfo._bindings)
{
