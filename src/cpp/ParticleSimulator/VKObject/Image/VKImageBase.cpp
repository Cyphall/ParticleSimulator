...
VKImageBase::VKImageBase(VKContext& context, vk::Format format, const glm::uvec2& size, vk::ImageLayout layout, int mipLevels, vk::ImageAspectFlags aspect): VKObject(context),
                                                                                                                                                             _format(format),
                                                                                                                                                             _size(size),
