...
VKSwapchainImage::VKSwapchainImage(VKContext& context, vk::Image handle, vk::Format format, const glm::uvec2& size): VKImageBase(context, format, size, vk::ImageLayout::eUndefined, 1, vk::ImageAspectFlagBits::eColor)
{
	_handle = handle;
