...
static VKAPI_ATTR vk::Bool32 VKAPI_CALL messageCallback(vk::DebugUtilsMessageSeverityFlagBitsEXT messageSeverity, vk::DebugUtilsMessageTypeFlagsEXT messageTypes, const vk::DebugUtilsMessengerCallbackDataEXT* messageData, void* userData)
{
	...
	{
	case vk::DebugUtilsMessageSeverityFlagBitsEXT::eError: std::cout << std::format("ERROR: {}", messageData->pMessage) << '\n' << std::endl;
		LOG_FILE << std::format("ERROR: {}", messageData->pMessage) << '\n' << std::endl;
		__debugbreak();
		break;
	case vk::DebugUtilsMessageSeverityFlagBitsEXT::eWarning: std::cout << std::format("WARNING: {}", messageData->pMessage) << '\n' << std::endl;
		LOG_FILE << std::format("WARNING: {}", messageData->pMessage) << '\n' << std::endl;
		break;
#if _DEBUG
	case vk::DebugUtilsMessageSeverityFlagBitsEXT::eInfo: std::cout << std::format("INFO: {}", messageData->pMessage) << '\n' << std::endl;
		LOG_FILE << std::format("INFO: {}", messageData->pMessage) << '\n' << std::endl;
		break;
	case vk::DebugUtilsMessageSeverityFlagBitsEXT::eVerbose: std::cout << std::format("NOTIF: {}", messageData->pMessage) << '\n' << std::endl;
